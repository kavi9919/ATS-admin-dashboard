...
export default function ViewNewFarmerDetails({fname, lname, email, username, nic, phoneNumber, profileImg, gnCertificate, cropTypes, addL1, addL2, addL3, nicFront, nicBack, NewUsers}) {
  const reasonRef = useRef(null);
  const [isLoading, setIsLoading] = useState(false);
  const [isReasonEmpty, setIsReasonEmpty] = useState(false);

  // Function for reject a farmer ---------------------------
  ...
  const reject = async()=>{
    ...
    try{
        ...
        setIsLoading(true);
        const response = await AdminService.rejectFarmer(data);
        setIsLoading(false);
  ...
  // Function for approve a farmer ---------------------------

  const approve = async()=>{
    try{
        setIsLoading(true);
        const response = await AdminService.approveFarmer(email);
        setIsLoading(false);
        window.location.reload();
        console.log(response);
    }
        ...
        <form className="py-16 bg-gray-100 dark:bg-gray-800">
            <div className="max-w-6xl px-4 mx-auto">
                <div className="p-6 bg-white border border-gray-100 rounded-lg shadow dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div className="w-full md:w-9/12">
                            <div className="flex flex-wrap -m-3">
                                ...
                                <div className="w-full p-3 md:flex-1">
                                    <input
                                        className="w-full px-4 py-2.5 dark:bg-gray-800 dark:border-gray-800 dark:placeholder-gray-500 dark:text-gray-400  text-base text-gray-900 rounded-lg font-normal border border-gray-200"
                                        type="text" value={cropTypes} readOnly/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="py-6 border-b border-gray-100 dark:border-gray-800">
                        <div className="w-full md:w-9/12">
                            <div className="flex flex-wrap -m-3">
                                ...
                                <div className="w-full p-3 md:flex-1">
                                    <div className="flex items-center justify-center w-full">
                                        <img src={`https://syntecblobstorage.blob.core.windows.net/nicimage/${nicFront}`}/>
                    ...
                    <div className="py-6 border-b border-gray-100 dark:border-gray-800">
                        <div className="w-full md:w-9/12">
                            <div className="flex flex-wrap -m-3">
                                ...
                                <div className="w-full p-3 md:flex-1">
                                    <div className="flex items-center justify-center w-full">
                                        <img src={`https://syntecblobstorage.blob.core.windows.net/nicimage/${nicBack}`}/>
                    ...
                    <div className="py-6 border-b-2 border-gray-500 dark:border-gray-800">
                        <div className="w-full md:w-9/12">
                            <div className="flex flex-wrap -m-3">
                                <FormLabel>Grama Sewa Niladari certificate</FormLabel>
                                <div className="w-full p-3 md:flex-1">
                                    <div className="flex items-center justify-center w-full">
                                        
                                                <img src={`https://syntecblobstorage.blob.core.windows.net/gramaniladhari/${gnCertificate}`}/>
