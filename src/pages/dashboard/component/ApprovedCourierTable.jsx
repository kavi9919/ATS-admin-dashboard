import {
  ...
  export function Tables() {
    ...
    // Get approved couriers from database -----------------------------

    useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await AdminService.getApprovedCouriers();
    ...
    return (
      <div>
        {isView && 
          <ViewCourierDetails fname={fname} lname={lname} email={email} username={username} nic={nic} phoneNumber={telephone} profileImg={profileImg} addL1={addL1} addL2={addL2} addL3={addL3} vehicleNo={vehicleNo} vehicleImg={vehicleImg} licenseImg={licenseImg} NewUsers={false}/>
        }
        {!isView &&
