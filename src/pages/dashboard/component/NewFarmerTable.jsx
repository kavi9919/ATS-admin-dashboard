import {
  ...
  export function Tables() {
    ...
    // Get new farmers from database -----------------------

    useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await AdminService.getNewFarmers();
    ...
    return (
      <div>
        {isView && 
          <ViewFarmerDetails fname={fname} lname={lname} email={email} username={username} nic={nic} phoneNumber={telephone} profileImg={profileImg} gnCertificate={gSCertificate} cropTypes={cropTypes} addL1={addL1} addL2={addL2} addL3={addL3} nicFront={nicFront} nicBack={nicBack} NewUsers={true}/>
        }
        {!isView && 
